...
public:
	...
	ResultAndCarry<U8> LogicalShiftLeft(const U8& value_in, const U8& shift_amount, const U1& carry_in);
	ResultAndCarry<U8> LogicalShiftRight(const U8& value_in, const U8& shift_amount, const U1& carry_in);
